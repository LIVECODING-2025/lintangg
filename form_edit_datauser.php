...
$wisata = mysqli_query($koneksi,"SELECT * FROM data_userr where id = '$id'");
...
<body id="page-top">
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold" style="color: #013220;">Form Edit Data Pemesanan</h6>
    </div>
    <div class="card-body">
        <form action="proses_edit_datauser.php" method="post" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?= $id;?>">
            <div class="row mb-3">
                <label for="username" class="form-label col-sm-2">Username</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="username" name="username" value="<?= $username;?>" autofocus>
                </div>
            </div>
            <div class="row mb-3">
                <label for="tanggal_booking" class="form-label col-sm-2">Tanggal Booking</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="tanggal_booking" name="tanggal_booking" value="<?= $tanggal_booking;?>" autofocus>
                </div>
            </div>
            <div class="row mb-3">
                <label for="notelfon" class="form-label col-sm-2">NoTelfon</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="notelfon" name="notelfon" value="<?= $notelfon?>">
                </div>
            </div>
            <div class="row mb-3">
